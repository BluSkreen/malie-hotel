    ...
    <div>
      <section>
        ...
        <img
          ...
          src="https://images.unsplash.com/photo-1524901548305-08eeddc35080?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
      ...
      <section className="bg-[rgba(207,181,59)] text-white mt-10 p-4 pb-10">
        ...
        <p class="font-semibold">
          Forget your troubles with one of our many relaxing spa services at The
          Oasis, located within our hotel. The challenges you face in everyday
          life can cause tension all throughout your body. Unnecessary stress
          can be detrimental to your physical and mental wellbeing. You deserve
          a day of luxury. That’s why our spa offers a plethora of packages. Our
          specially trained staff is here to serve you.
        </p>
        <div className="flex flex-wrap justify-around mt-10 rounded">
          <div>
            ...
            />
            <h2 className="text-[24px] text-center underline">Massages</h2>
            <p className="max-w-[450px]">
              Reduce stress, anxiety/depression, and relieve muscle pain with
              one of our massage services. We offer Swedish, reflexology, and
              everything in between. Add CBD to any session of your choice for
              some added healing. Your body will be glowing with gratitude!
              <ul class="mt-6 list-none">
                <li>
                  <p class="font-extrabold">Menu:</p>
                </li>
          ...
          <div>
            <img
              ...
              className="max-w-[450px] border-solid border-4 border-white mb-4"
            />
            <h2 className="text-[24px] text-center underline">Manicures</h2>
            <p className="max-w-[450px]">
              Not only do we offer a go-to signature manicure/pedicure combo,
              but we also do trendy nail art. Add sparkles, flowers, logos, or
              whatever it is that your heart desires. Take your pick of gel,
              dip, or shellac. All manicures come with cuticle care, reshaping
              of the nail, a hand massage with lotion, and a hot towel.
              <ul class="mt-6 list-none">
                <li>
                  <p class="font-extrabold">Menu:</p>
                </li>
          ...
          <div>
            ...
            />
            <h2 className="text-[24px] text-center underline">Pedicures</h2>
            <p className="max-w-[450px]">
              All of our pedicure services include a soak, nail and cuticle
              care, exfoliation, and 5-10 minutes of a light massage. The Spa
              Pedicure comes with callus removal and a paraffin hot wax wrap,
              and the Luxe Pedicure package has it all -with essential oils and
              a foot mask that will leave your feet unbelievably smooth!
              <ul class="mt-6 list-none">
                <li>
                  <p class="font-extrabold">Menu:</p>
                </li>
