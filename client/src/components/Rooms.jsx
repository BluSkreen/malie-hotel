    ...
    return (
        <div className="bg-[#faf7eb] w-full overflow-hidden">
            <div className="flex justify-center">
                <form className=" bg-black p-4 m-4 rounded-lg border-8 border-[rgba(207,181,59)] w-3/4">
            ...
            <div className="mb-2 flex p-1 justify-around items-center flex-wrap ">
                ...
                {executiveKing ? (
                    <div className=" text-center m-10  bg-black p-4 rounded-xl shadow-lg shadow-black">
                        <img
                            src={
                                "https://images.unsplash.com/photo-1609602126247-4ab7188b4aa1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8ODR8fGhvdGVsJTIwcm9vbXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60"
                            }
                            alt="hotel room"
                            className="w-[500px]  border-2 border-[rgba(207,181,59)] mb-6"
                        />
                ...
                {choiceQueen ? (
                    <div className=" text-center m-10  bg-black p-4 rounded-xl shadow-lg shadow-black">
                        <img
                            src={
                                "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cmVzb3J0JTIwcm9vbXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60"
                            }
                            alt="hotel room"
                            className="w-[500px]  border-2 border-[rgba(207,181,59)] mb-6"
                        />
                ...
                {deluxeQueen ? (
                    <div className=" text-center m-10  bg-black p-4 rounded-xl shadow-lg shadow-black">
                        <img
                            src={
                                "https://images.unsplash.com/photo-1638121757833-274f0c93e3b0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NTR8fHJlc29ydCUyMHJvb218ZW58MHx8MHx8&auto=format&fit=crop&w=800&q=60"
                            }
                            alt="hotel room"
                            className="w-[500px]  border-2 border-[rgba(207,181,59)] mb-6"
                        />
