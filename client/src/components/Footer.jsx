                ...
                <div className="flex justify-around py-10 text-center text-[rgba(207,181,59)]">
                    ...
                    <div>
                        ...
                        <div className="text-[12px]">
                            <p>
                                {" "}
                                <a href="https://github.com/SHD327" target="_blank">
                                    {" "}
                                    Sid's GitHub
                                </a>{" "}
                            </p>
                            <p>
                                {" "}
                                <a href="https://github.com/BluSkreen" target="_blank">
                                    {" "}
                                    Jason's GitHub
                                </a>{" "}
                            </p>
                            <p>
                                {" "}
                                <a href="https://github.com/Darin1027" target="_blank">
                                    Darin's GitHub
                                </a>{" "}
                            </p>
                            <p>
                                {" "}
                                <a href="https://github.com/larsonrj" target="_blank">
                                    {" "}
                                    Ryan's GitHub{" "}
                                </a>
                            </p>
                            <p>
                                {" "}
                                <a href="https://github.com/NicoletteBoggs" target="_blank">
                                    {" "}
                                    Nicolette's GitHub{" "}
                                </a>
                            </p>
                            <p>
                                {" "}
                                <a href="https://github.com/eebbinghaus" target="_blank">
                                    {" "}
                                    Erich's GitHub{" "}
                                </a>
                            </p>
